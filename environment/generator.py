...
class Generator:
    ...
    def add_bnez(self, left, target):
        self.Code.append(f"bnez {left}, {target}\n")
        
    #t1 y t2
    def add_blez1(self, left, right, target):
        self.Code.append(f"\tsub t0, {left}, {right}\n")
        self.Code.append(f"\tblez t0, {target}\n")
...
#t1 = 2, <= t2 = 3
    ...
    def add_addi(self, left, right):
        self.Code.append(f"\taddi {left}, {right}, 1\n")
